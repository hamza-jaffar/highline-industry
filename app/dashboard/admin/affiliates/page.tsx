...
export default async function AdminAffiliatesPage() {
  ...
  return (
    <div className="space-y-12 max-w-7xl mx-auto p-2 pb-24">
      {/* Header */}
      <div className="flex flex-col border-b border-black/10 pb-8 space-y-2 text-center md:text-left">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-black text-white text-[10px] font-black uppercase tracking-widest rounded-xl mb-4 w-fit mx-auto md:mx-0">
        ...
        <p className="text-black/50 font-medium text-sm">
          Control commissions, approve applications, and audit revenue flow.
        </p>
      </div>
