...
export default function FactoryPage() {
    ...
    return (
        <div className="p-3 space-y-8 w-full max-w-6xl mx-auto">
            {/* Toast */}
            {toast && (
                <div
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="inline-flex items-center gap-2 p-2 rounded-full bg-gradient-to-r from-black/10 to-gray-100 border border-black/10 text-xs font-semibold text-black tracking-wide mb-4 shadow-inner">
                        <Factory className="w-3 h-3" />
                        {isEditing ? "Editing Factory" : "Setup Factory"}
                    </div>
                    <h1 className="text-4xl font-sora font-bold text-black">
                        {isEditing ? "Factory Settings" : "Create Your Factory"}
                    </h1>
                    <p className="text-muted text-base mt-2 max-w-md">
                        {isEditing
                            ? "Update your factory information. Changes take effect immediately."
                            : "Set up your factory profile. You can only have one factory — this is your global identity."}
                    </p>
                </div>
                {isEditing && (
                    <div className="px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl shrink-0">
