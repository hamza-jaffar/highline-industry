      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-[#737373] text-sm mt-1">Manage your active manufacturing orders.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <button key={i} className="flex flex-col text-left p-6 bg-white border border-black/10 rounded-xl shadow-sm hover:border-black/30 hover:shadow-premium transition-all">
               <div className="w-10 h-10 rounded-lg bg-[#fafafa] border border-black/5 flex items-center justify-center mb-4">
        ...
        <div className="p-8 bg-white border border-black/10 rounded-xl shadow-sm text-center py-16">
            ...
            <p className="text-[#737373] text-sm mb-6">Head to the catalog to configure your first garment system.</p>
            <Link href="/shop" className="inline-flex px-4 py-2 border border-black/10 text-black text-sm font-semibold rounded-md shadow-sm hover:bg-[#fafafa] transition-colors">
                Browse Catalog
            </Link>
        </div>
